...
const DashboardPage = () => {
  ...
  const fetchUserData = async () => {
    ...
    try {
      ...
      setError('Erro ao buscar dados do usuário: ' + (err.message || 'Erro desconhecido'));
    } finally {
      setLoading(false);
    }
  };
  ...
  const fetchAdminData = async () => {
    ...
    try {
      ...
      setError('Erro ao buscar dados de administrador: ' + (err.message || 'Acesso negado'));
    } finally {
      setLoading(false);
    }
  };
          ...
          <div className="card fade-in" style={{animationDelay: '0.1s'}}>
            ...
            <div className="space-y-3">
              <Button
                ...
                className="btn-full"
              >
                {loading ? 'Buscando...' : 'Buscar Dados do Usuário'}
              </Button>
              ...
              <Button
                ...
                className="btn-full"
              >
                {loading ? 'Buscando...' : 'Buscar Dados de Admin'}
              </Button>
            </div>
          </div>
        </div>
          ...
          <div className="card md:col-span-2 fade-in" style={{animationDelay: '0.2s'}}>
            ...
            {userData && (
              <div className="alert alert-success mb-4">
                <h4 className="font-semibold mb-2">✅ Dados do Usuário Recebidos:</h4>
            ...
            {adminData && (
              <div className="alert alert-success">
                <h4 className="font-semibold mb-2">🔒 Dados de Admin Recebidos:</h4>
                <div className="bg-black/20 rounded p-3 mt-2">
                  <pre className="text-xs text-green-800 whitespace-pre-wrap font-mono">
